...
@Entity
@Table(name = "kod_ansvarstyp")
public class KodAnvarstypEntity implements KodEntity {
	...
	public static KodAnvarstypEntity create() {
		return new KodAnvarstypEntity();
	}
	...
	public KodAnvarstypEntity withId(final Integer id) {
		this.id = id;
		return this;
	}
	...
	public KodAnvarstypEntity withKod(final String kod) {
		this.kod = kod;
		return this;
	}
	...
	public KodAnvarstypEntity withNamn(final String namn) {
		this.namn = namn;
		return this;
	}
	...
	public KodAnvarstypEntity withOrdning(final Integer ordning) {
		this.ordning = ordning;
		return this;
	}
	...
	public boolean equals(final Object o) {
		...
		if (!(o instanceof final KodAnvarstypEntity that)) {
			return false;
		}
