...
@Entity
@Table(name = "kod_personuppgift")
public class KodPersonuppgiftEntity implements KodEntity {
	...
	public static KodPersonuppgiftEntity create() {
		return new KodPersonuppgiftEntity();
	}
	...
	public KodPersonuppgiftEntity withId(final Integer id) {
		this.id = id;
		return this;
	}
	...
	public KodPersonuppgiftEntity withKod(final String kod) {
		this.kod = kod;
		return this;
	}
	...
	public KodPersonuppgiftEntity withNamn(final String namn) {
		this.namn = namn;
		return this;
	}
	...
	public KodPersonuppgiftEntity withOrdning(final Integer ordning) {
		this.ordning = ordning;
		return this;
	}
	...
	public KodPersonuppgiftEntity withBeskrivning(final String beskrivning) {
		this.beskrivning = beskrivning;
		return this;
	}
	...
	public boolean equals(final Object o) {
		...
		if (!(o instanceof final KodPersonuppgiftEntity that)) {
			return false;
		}
