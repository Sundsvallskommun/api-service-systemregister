...
@Entity
@Table(name = "kod_gallringsfrist_typ")
public class KodGallringsfristTypEntity implements KodEntity {
	...
	public static KodGallringsfristTypEntity create() {
		return new KodGallringsfristTypEntity();
	}
	...
	public KodGallringsfristTypEntity withId(final Integer id) {
		this.id = id;
		return this;
	}
	...
	public KodGallringsfristTypEntity withKod(final String kod) {
		this.kod = kod;
		return this;
	}
	...
	public KodGallringsfristTypEntity withNamn(final String namn) {
		this.namn = namn;
		return this;
	}
	...
	public KodGallringsfristTypEntity withOrdning(final Integer ordning) {
		this.ordning = ordning;
		return this;
	}
	...
	public KodGallringsfristTypEntity withBeskrivning(final String beskrivning) {
		this.beskrivning = beskrivning;
		return this;
	}
	...
	public boolean equals(final Object o) {
		...
		if (!(o instanceof final KodGallringsfristTypEntity that)) {
			return false;
		}
	...
	public String toString() {
		return "KodGallringsfristTypEntity{" +
			"id=" + this.id +
			", kod='" + this.kod + '\'' +
			", namn='" + this.namn + '\'' +
