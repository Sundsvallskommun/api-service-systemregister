...
@Entity
@Table(name = "kod_registrering")
public class KodRegistreringEntity implements KodEntity {
	...
	public static KodRegistreringEntity create() {
		return new KodRegistreringEntity();
	}
	...
	public KodRegistreringEntity withId(final Integer id) {
		this.id = id;
		return this;
	}
	...
	public KodRegistreringEntity withKod(final String kod) {
		this.kod = kod;
		return this;
	}
	...
	public KodRegistreringEntity withNamn(final String namn) {
		this.namn = namn;
		return this;
	}
	...
	public KodRegistreringEntity withOrdning(final Integer ordning) {
		this.ordning = ordning;
		return this;
	}
	...
	public KodRegistreringEntity withBeskrivning(final String beskrivning) {
		this.beskrivning = beskrivning;
		return this;
	}
	...
	public boolean equals(final Object o) {
		...
		if (!(o instanceof final KodRegistreringEntity that)) {
			return false;
		}
