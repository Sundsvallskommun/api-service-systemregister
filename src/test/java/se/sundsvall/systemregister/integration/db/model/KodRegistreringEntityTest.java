...
class KodRegistreringEntityTest {

	@Test
	void testBean() {
		assertThat(KodRegistreringEntity.class, allOf(
	...
	void testBuilderMethods() {
		...
		final var result = KodRegistreringEntity.create()
			.withId(id)
			.withKod(kod)
			.withNamn(namn)
			.withOrdning(ordning)
	...
	void testNoDirtOnCreatedBean() {
		assertThat(KodRegistreringEntity.create()).hasAllNullFieldsOrProperties();
		assertThat(new KodRegistreringEntity()).hasAllNullFieldsOrProperties();
	}
}
