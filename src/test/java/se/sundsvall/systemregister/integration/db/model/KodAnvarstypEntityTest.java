...
class KodAnvarstypEntityTest {

	@Test
	void testBean() {
		assertThat(KodAnvarstypEntity.class, allOf(
	...
	void testBuilderMethods() {
		...
		final var result = KodAnvarstypEntity.create()
			.withId(id)
			.withKod(kod)
			.withNamn(namn)
			.withOrdning(ordning);
	...
	void testNoDirtOnCreatedBean() {
		assertThat(KodAnvarstypEntity.create()).hasAllNullFieldsOrProperties();
		assertThat(new KodAnvarstypEntity()).hasAllNullFieldsOrProperties();
	}
}
