...
class KodGallringsfristTypEntityTest {

	@Test
	void testBean() {
		assertThat(KodGallringsfristTypEntity.class, allOf(
	...
	void testBuilderMethods() {
		...
		final var result = KodGallringsfristTypEntity.create()
			.withId(id)
			.withKod(kod)
			.withNamn(namn)
			.withOrdning(ordning)
	...
	void testNoDirtOnCreatedBean() {
		assertThat(KodGallringsfristTypEntity.create()).hasAllNullFieldsOrProperties();
		assertThat(new KodGallringsfristTypEntity()).hasAllNullFieldsOrProperties();
	}
}
