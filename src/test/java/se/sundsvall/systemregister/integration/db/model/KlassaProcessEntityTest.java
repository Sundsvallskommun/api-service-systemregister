...
class KlassaProcessEntityTest {

	@Test
	void testBean() {
		assertThat(KlassaProcessEntity.class, allOf(
	...
	void testBuilderMethods() {
		...
		final var result = KlassaProcessEntity.create()
			.withId(id)
			.withKod(kod)
			.withNamn(namn)
	...
	void testNoDirtOnCreatedBean() {
		assertThat(KlassaProcessEntity.create()).hasAllNullFieldsOrProperties();
		assertThat(new KlassaProcessEntity()).hasAllNullFieldsOrProperties();
	}
}
