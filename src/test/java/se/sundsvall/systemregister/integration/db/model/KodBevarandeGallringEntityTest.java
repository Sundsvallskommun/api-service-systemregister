...
class KodBevarandeGallringEntityTest {

	@Test
	void testBean() {
		assertThat(KodBevarandeGallringEntity.class, allOf(
	...
	void testBuilderMethods() {
		...
		final var result = KodBevarandeGallringEntity.create()
			.withId(id)
			.withKod(kod)
			.withNamn(namn)
			.withOrdning(ordning)
	...
	void testNoDirtOnCreatedBean() {
		assertThat(KodBevarandeGallringEntity.create()).hasAllNullFieldsOrProperties();
		assertThat(new KodBevarandeGallringEntity()).hasAllNullFieldsOrProperties();
	}
}
