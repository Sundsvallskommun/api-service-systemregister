...
class KlassaVerksamhetsomradeTest {

	@Test
	void testBean() {
		assertThat(KlassaVerksamhetsomrade.class, allOf(
	...
	void testBuilderMethods() {
		...
		final var result = KlassaVerksamhetsomrade.create()
			.withId(id)
			.withKod(kod)
			.withNamn(namn)
	...
	void testNoDirtOnCreatedBean() {
		assertThat(KlassaVerksamhetsomrade.create()).hasAllNullFieldsOrProperties();
		assertThat(new KlassaVerksamhetsomrade()).hasAllNullFieldsOrProperties();
	}
}
