...
class EventLogTest {
	...
	@Test
	void testBean() {
		assertThat(EventLog.class, allOf(
	...
	void testBuilderMethods() {
		...
		final var performedAt = OffsetDateTime.now();
		final var description = "description";
		final var acknowledgedAt = OffsetDateTime.now().plusDays(1);

		final var result = EventLog.create()
			.withId(id)
	...
	void testNoDirtOnCreatedBean() {
		assertThat(EventLog.create()).hasAllNullFieldsOrProperties();
		assertThat(new EventLog()).hasAllNullFieldsOrProperties();
	}
}
